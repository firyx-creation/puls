...
export default function Feed() {
  ...
  useEffect(() => {
    const checkMaintenance = async () => {
      ...
      // Si maintenance activée et user pas admin, afficher le modal
