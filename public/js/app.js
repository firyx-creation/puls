...
async function publishPost() {
  ...
  try {
    ...
    // Dans la fonction qui publie le post (côté Admin)
    if (notifyUsers) {
      const message = {
        app_id: "fa5e5464-d139-4d38-b9d8-438d9f753375",
        contents: { "fr": title },
        headings: { "fr": "puls. - " + STATE.selectedTheme },
        url: "https://puls-eight.vercel.app/",
        // On envoie uniquement à ceux qui ont le tag du thème
        filters: [
          { "field": "tag", "key": STATE.selectedTheme, "relation": "=", "value": "true" }
        ]
      };

      // Envoi via l'API OneSignal
      fetch("https://onesignal.com/api/v1/notifications", {
        method: "POST",
        headers: {
          "Content-Type": "application/json; charset=utf-8",
          "Authorization": "Basic os_v2_app_7jpfizgrhfgtrooyiogz65jtowbxkbdn5wdemvv5h4tjquv62hyqwjyilns3765bnse3ms23fekbn6aichbfdz2dzoxkjtqnt77c4lq" // Trouvable dans tes réglages OneSignal
        },
